    ...
    <div class="d-flex flex-column gap-3">
      <div>
        ...
        <ul class="border-start border-4 border-secondary list-unstyled ps-3">
          <li>CPU · <span class="text-secondary">Intel Core i9 12900k</span></li>
          <li>MOBO · <span class="text-secondary">Asus ROG STRIX Z690-F GAMING WIFI</span></li>
          <li>RAM · <span class="text-secondary">32GB Team T-Force Delta RGB DDR5 6200mhz</span></li>
          <li>SSD · <span class="text-secondary">1TB AORUS Gen4 7000s</span></li>
          <li>Tarro · <span class="text-secondary">Cougar MX660 Mesh RGB</span></li>
          <li>WC · <span class="text-secondary">Asus ROG STRIX LC II 360 ARGB</span></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="border-start border-4 border-secondary list-unstyled ps-3">
          <li>Monitor · <span class="text-secondary">Ozone DSP27 IPS</span></li>
          <li>Keyboard · <span class="text-secondary">Razer Huntsman Elite</span></li>
          <li>Mouse · <span class="text-secondary">Razer Naga Pro</span></li>
          <li>Headsets · <span class="text-secondary">Razer Nari Ultimate</span></li>
